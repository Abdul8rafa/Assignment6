...
import icon from "@/public/Ddsgnr Library (2).png";
import social_links from "@/public/Social Links.png";
            ...
            <div className="flex flex-col items-center w-screen h-[700px]">
                <div className="flex flex-col justify-center items-center gap-[10px]">
                    <div className="flex flex-col justify-center items-center gap-[20px] xl:flex-row xl:justify-between xl:w-screen">
                        ...
                        <div className="flex flex-col justify-center items-center gap-[20px] xl:flex-row xl:mr-[40px]">
                            ...
                            <button className="w-[380px] xl:w-[119px] h-[48px] text-[16px] text-center border border-black rounded-[5px]">Subscribe</button>
                ...
                <div className="flex flex-col gap-[40px] w-[172px] h-[856px] mt-[40px] xl:w-screen xl:h-[500px] xl:flex-row xl:gap-[150px] xl:justify-center xl:items-center">
                    <div className="flex flex-col xl:w-[250px] xl:h-[270px]">
                        <Image src={icon} alt="n" width={172} height={40}></Image>
                ...
                <div className="w-[80vw] mt-[50px] mb-[50px] m-auto h-[2px] border-t-2 border-black">

                </div>
                <div className="flex flex-col justify-center items-center gap-[24px] w-screen h-[114px] xl:flex-row xl:justify-between">
                    ...
                    <div className="xl:mr-[126px]">
                        <Image src={social_links} alt="m" width={132} height={24}></Image>
